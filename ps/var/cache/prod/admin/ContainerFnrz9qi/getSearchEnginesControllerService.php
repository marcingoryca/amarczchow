...
class getSearchEnginesControllerService extends AdminKernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $instance->setContainer(($container->privates['.service_locator.GFCNCM5'] ?? $container->load('get_ServiceLocator_GFCNCM5Service'))->withContext('PrestaShopBundle\\Controller\\Admin\\Configure\\ShopParameters\\SearchEnginesController', $container));
